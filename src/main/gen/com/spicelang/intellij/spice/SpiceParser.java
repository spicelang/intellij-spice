...
public class SpiceParser implements PsiParser, LightPsiParser {
  ...
  /* ********************************************************** */
  // fctAttr? EXT (F LESS dataType GREATER | P) identifierExpr LPAREN (typeLst ELLIPSIS?)? RPAREN SEMICOLON
  ...
  /* ********************************************************** */
  // PLUS | MINUS | MUL | DIV | EQUAL | NOT_EQUAL | PLUS_EQUAL | MINUS_EQUAL | MUL_EQUAL | DIV_EQUAL | PLUS_PLUS | MINUS_MINUS
