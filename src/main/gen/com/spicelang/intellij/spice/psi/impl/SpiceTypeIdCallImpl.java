...
public class SpiceTypeIdCallImpl extends ASTWrapperPsiElement implements SpiceTypeIdCall {

  public SpiceTypeIdCallImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SpiceVisitor visitor) {
    visitor.visitTypeIdCall(this);
  }
