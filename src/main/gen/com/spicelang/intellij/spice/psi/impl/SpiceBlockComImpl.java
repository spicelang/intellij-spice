...
public class SpiceBlockComImpl extends ASTWrapperPsiElement implements SpiceBlockCom {

  public SpiceBlockComImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SpiceVisitor visitor) {
    visitor.visitBlockCom(this);
  }
