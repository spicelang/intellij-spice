...
public class SpiceDefaultBranchImpl extends ASTWrapperPsiElement implements SpiceDefaultBranch {

  public SpiceDefaultBranchImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SpiceVisitor visitor) {
    visitor.visitDefaultBranch(this);
  }
