...
public class SpiceForeachHeadImpl extends ASTWrapperPsiElement implements SpiceForeachHead {

  public SpiceForeachHeadImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SpiceVisitor visitor) {
    visitor.visitForeachHead(this);
  }
