...
public class SpicePrintfCallImpl extends ASTWrapperPsiElement implements SpicePrintfCall {

  public SpicePrintfCallImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SpiceVisitor visitor) {
    visitor.visitPrintfCall(this);
  }
