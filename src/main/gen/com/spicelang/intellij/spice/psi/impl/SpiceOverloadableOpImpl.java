...
public class SpiceOverloadableOpImpl extends ASTWrapperPsiElement implements SpiceOverloadableOp {

  public SpiceOverloadableOpImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SpiceVisitor visitor) {
    visitor.visitOverloadableOp(this);
  }
