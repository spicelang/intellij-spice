...
public class SpiceModAttrImpl extends ASTWrapperPsiElement implements SpiceModAttr {

  public SpiceModAttrImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SpiceVisitor visitor) {
    visitor.visitModAttr(this);
  }
