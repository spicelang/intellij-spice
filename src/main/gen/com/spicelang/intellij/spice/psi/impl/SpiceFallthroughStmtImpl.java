...
public class SpiceFallthroughStmtImpl extends ASTWrapperPsiElement implements SpiceFallthroughStmt {

  public SpiceFallthroughStmtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SpiceVisitor visitor) {
    visitor.visitFallthroughStmt(this);
  }
