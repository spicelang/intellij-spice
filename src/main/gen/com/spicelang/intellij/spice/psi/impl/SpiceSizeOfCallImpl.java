...
public class SpiceSizeOfCallImpl extends ASTWrapperPsiElement implements SpiceSizeOfCall {

  public SpiceSizeOfCallImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SpiceVisitor visitor) {
    visitor.visitSizeOfCall(this);
  }
