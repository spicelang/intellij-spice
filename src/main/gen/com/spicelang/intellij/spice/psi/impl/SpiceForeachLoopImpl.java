...
public class SpiceForeachLoopImpl extends ASTWrapperPsiElement implements SpiceForeachLoop {

  public SpiceForeachLoopImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public SpiceForeachHead getForeachHead() {
    return findNotNullChildByClass(SpiceForeachHead.class);
  }
