...
public class SpiceTypeLstImpl extends ASTWrapperPsiElement implements SpiceTypeLst {

  public SpiceTypeLstImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SpiceVisitor visitor) {
    visitor.visitTypeLst(this);
  }
