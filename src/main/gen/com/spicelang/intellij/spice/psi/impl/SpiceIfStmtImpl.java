...
public class SpiceIfStmtImpl extends ASTWrapperPsiElement implements SpiceIfStmt {

  public SpiceIfStmtImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public SpiceElseStmt getElseStmt() {
    return findChildByClass(SpiceElseStmt.class);
  }
