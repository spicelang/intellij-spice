...
public class SpiceElseStmtImpl extends ASTWrapperPsiElement implements SpiceElseStmt {

  public SpiceElseStmtImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public SpiceIfStmt getIfStmt() {
    return findChildByClass(SpiceIfStmt.class);
  }
