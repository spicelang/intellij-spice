...
public class SpiceAnonymousBlockStmtImpl extends ASTWrapperPsiElement implements SpiceAnonymousBlockStmt {

  public SpiceAnonymousBlockStmtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SpiceVisitor visitor) {
    visitor.visitAnonymousBlockStmt(this);
  }
